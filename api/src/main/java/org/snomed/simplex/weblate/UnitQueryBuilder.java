...
public class UnitQueryBuilder {
    ...
    public UnitQueryBuilder changedSince(Instant changedSince) {
    ...
    public String build() {
        ...
        if (changedSince != null) {
            ...
            String formattedTime = DateTimeFormatter.ISO_INSTANT.format(changedSince);
